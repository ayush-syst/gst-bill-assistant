...
> filesystem (`file://`) won't load. Once served, regex extraction **and PDF text extraction
> work fully offline** (PDF.js is self-hosted); only AI features and **image OCR** (Tesseract,
> still on CDN) need internet.
